...
```
**path_to_original_samples.vcf:**  Name of the input vcf file that contains the genomic data requiring imputation. The file should be in a vcf format.
**path_to_chimeric_reference.vcf:**  Name of the chimeric reference file generated by Retriever. The file should be in a vcf format.
**ame_of_imputed_file:**  The file name for saving the imputed genomic data. Beagle will add the file type to this file by default so no need to specify the file type in this argument.
